...
const Notes = () => {
  ...
  if (filteredNotes.length > 0) {
    return (
      <ul className='h-80 md:h-96 overflow-auto text-white w-11/12 lg:w-8/12 grid grid-cols-2 md:grid-cols-3 gap-2 bg-black border-4 border-gray-300 my-3 rounded-xl p-3 shadow-lg text-xs md:text-sm lg:text-base lg:p-4'>
